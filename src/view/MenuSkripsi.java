...
import tableModel.TabelSkripsi;
...
public class MenuSkripsi extends javax.swing.JPanel {
    ...
    private TabelSkripsi tbl = new TabelSkripsi();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/skripsi1.png"))); // NOI18N
        jLabel1.setText("Data Skripsi Perpustakaan");

        cbx_cari.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        cbx_cari.setForeground(new java.awt.Color(204, 204, 204));
        cbx_cari.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "JUDUL", "PENULIS", "PEMBIMBING", "KATEGORI", "PROGRAM STUDI", "FAKULTAS" }));
    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
        ...
        ImageIcon icon = new ImageIcon(getClass().getResource("/img/hapus1.png"));
        if(JOptionPane.showConfirmDialog(null, "Menghapus skripsi dengan ID "+s, "Apakah anda yakin", 0, 0, icon)==0)
    ...
    private void btn_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tambahActionPerformed
        if(btn_tambah.getText().equalsIgnoreCase("UBAH"))
            new TambahSkripsi(null,true,(String) tbl_conten.getValueAt(tbl_conten.getSelectedRow(), 1)).setVisible(true);
        else
            new TambahSkripsi(null,true).setVisible(true);
        loadData();
    ...
    private void setColWidht() {
        int[] noCol = {0,1,3,4,5,6,7,8};
        int[] noColW = {35,80,100,100,80,50,150,150};
