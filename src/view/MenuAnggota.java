...
public class MenuAnggota extends javax.swing.JPanel {
    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
        ...
        ImageIcon icon = new ImageIcon(getClass().getResource("/img/hapus1.png"));
        if(JOptionPane.showConfirmDialog(null, "Menghapus anggota dengan ID "+s, "Apakah anda yakin", 0, 0, icon)==0)
    ...
    private void btn_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tambahActionPerformed
        if(btn_tambah.getText().equalsIgnoreCase("UBAH"))
            new TambahAnggota(null,true,(String) tbl_conten.getValueAt(tbl_conten.getSelectedRow(), 1)).setVisible(true);
        else 
            new TambahAnggota(null,true).setVisible(true);
